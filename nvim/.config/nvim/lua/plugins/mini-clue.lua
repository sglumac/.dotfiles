  ...
  config = function()
    ...
    miniclue.setup({
      ...
      clues = {
        ...
        { mode = 'n', keys = '<leader>dk', postkeys = '<leader>d',         action = dap.step_back,    desc = 'step back' },
        ...
        { mode = 'n', keys = '<leader>dr', postkeys = '<leader>d',         action = dap.repl.open,    desc = 'open repl' },
